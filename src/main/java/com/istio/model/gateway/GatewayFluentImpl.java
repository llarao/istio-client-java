...
public class GatewayFluentImpl<A extends GatewayFluent<A>> extends io.fabric8.kubernetes.api.builder.BaseFluent<A> implements GatewayFluent<A> {
     ...
     */
    @Override
    @Deprecated public GatewaySpec getSpec(){
    ...
    public class SpecNestedImpl<N> extends GatewaySpecFluentImpl<SpecNested<N>> implements SpecNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{
