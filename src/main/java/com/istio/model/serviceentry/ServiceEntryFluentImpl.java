 ...
 * @Create by llarao
 */
public class ServiceEntryFluentImpl<A extends ServiceEntryFluent<A>> extends io.fabric8.kubernetes.api.builder.BaseFluent<A> implements ServiceEntryFluent<A> {
    ...
    public A withSpec(ServiceEntrySpec spec){
        ...
        if (spec!=null){
            this.spec= new ServiceEntrySpecBuilder(spec);
    ...
    public class SpecNestedImpl<N> extends ServiceEntrySpecFluentImpl<SpecNested<N>> implements SpecNested<N>,io.fabric8.kubernetes.api.builder.Nested<N>{

        private final ServiceEntrySpecBuilder builder;
