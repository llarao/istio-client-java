...
@ApiVersion("v1")
@ApiGroup("")
public class DestinationRuleList implements KubernetesResource, KubernetesResourceList {
    @JsonProperty("apiVersion")
    private String apiVersion = "networking.istio.io/v1alpha3";
    @JsonProperty("items")
    private List<DestinationRule> items = new ArrayList();
    @JsonProperty("kind")
    ...
    public DestinationRuleList(String apiVersion, List<DestinationRule> items, String kind, ListMeta metadata) {
    ...
    public boolean equals(Object o) {
        if (o == this) {
            return true;
        } else if (!(o instanceof DestinationRuleList)) {
            return false;
        } else {
            DestinationRuleList other = (DestinationRuleList) o;
