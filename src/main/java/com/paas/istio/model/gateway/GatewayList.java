...
@ApiVersion("v1")
@ApiGroup("")
public class GatewayList implements KubernetesResource, KubernetesResourceList {
    @JsonProperty("apiVersion")
    private String apiVersion = "networking.istio.io/v1alpha3";
    @JsonProperty("items")
    private List<Gateway> items = new ArrayList();
    @JsonProperty("kind")
    ...
    public GatewayList(String apiVersion, List<Gateway> items, String kind, ListMeta metadata) {
