...
@ApiVersion("v1")
@ApiGroup("")
public class ServiceEntryList implements KubernetesResource, KubernetesResourceList {
    @JsonProperty("apiVersion")
    private String apiVersion = "networking.istio.io/v1alpha3";
    @JsonProperty("items")
    private List<ServiceEntry> items = new ArrayList();
    @JsonProperty("kind")
    ...
    public ServiceEntryList(String apiVersion, List<ServiceEntry> items, String kind, ListMeta metadata) {
    ...
    public boolean equals(Object o) {
        if (o == this) {
            return true;
        } else if (!(o instanceof ServiceEntryList)) {
            return false;
        } else {
            ServiceEntryList other = (ServiceEntryList) o;
